...
<!-- Preloader Starts -->
   ...
   Thank you for using foodfun. These Terms of Service (the "Terms") are intended to make you aware of your legal rights and responsibilities with respect to your access to and use of the foodfun website at www.foodfun.com (the "Site") and any related mobile or software applications ("foodfun Platform") including but not limited to delivery of information via the website whether existing now or in the future that link to the Terms (collectively, the "Services").

These Terms are effective for all existing and future foodfun users, including but without limitation to users having access to 'restaurant business page' to manage their claimed business listings.

Please read these Terms carefully. By accessing or using the foodfun Platform, you are agreeing to these Terms and concluding a legally binding contract with foodfun Media Pvt. Ltd. and/or its affiliates or, if you are in the United States, with foodfun USA, LLC and/or its affiliates (hereinafter collectively referred to as "foodfun"). You may not use the Services if you do not accept the Terms or are unable to be bound by the Terms. Your use of the foodfun Platform is at your own risk, including the risk that you might be exposed to content that is objectionable, or otherwise inappropriate.

In order to use the Services, you must first agree to the Terms. You can accept the Terms by:

Clicking to accept or agree to the Terms, where it is made available to you by foodfun in the user interface for any particular Service; or
Actually using the Services. In this case, you understand and agree that foodfun will treat your use of the Services as acceptance of the Terms from that point onwards.
II. Definitions
User
